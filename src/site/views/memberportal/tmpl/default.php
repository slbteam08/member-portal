    ...
    <div class="col-sm-5 col-12">
      ...
      <div class="year-select-container">
        ...
        <select class="year-select" name="year" id="year" onchange="onYearChanged()">
          ...
          ?>
            <option value="<?php echo $y; ?>" <?php if ($this->year==$y) { echo "selected"; } ?>><?php echo $y; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-12 info-box">
      <div class="col-12 info-heatMap">
        <div id="heatmap-week">
          <div id="chart2">
            <apexchart type="heatmap" height="200" width="100%" :options="chartOptions" :series="series">
            </apexchart>
          </div>
        </div>
        ...
        <div id="heatmap-month">
          <div id="chart3">
            <apexchart type="heatmap" height="100" width="100%" :options="chartOptions" :series="series">
            </apexchart>
          </div>
        </div>
    ...
    <div class="col-12 info-box">
      <div class="col-12 info-course">
        ...
        <div class="course row">
          <div class="course-name col-3 <?php echo $category["css_classes"]; ?>">
            <?php echo $category["category"]; ?></div>
          <div class="course-group col-9 col-md-8">
            <?php
            foreach ($category["courses"] as $course) {
                ?>
            <div class="course-name course-<?php echo $this->course_status[$course]; ?>">
              <?php echo $course; ?></div>
            <?php
            } ?>
          </div>
